...
rm -rf db
./migrator --mode backup --endpoint "http://127.0.0.1:12379" --db-dir db --debug
./migrator --mode restore --endpoint "unix:///var/snap/microk8s/current/var/kubernetes/backend/kine.sock" --db-dir db --debug
